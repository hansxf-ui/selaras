...
export default function SignupPage() {
  ...
  async function handleOAuth(provider) {
    ...
    if (error) setOauthError(`Daftar dengan ${provider} belum aktif di akun ini.`);
  }
    ...
    return (
      <div className="page-center">
        <div className="card-panel" style={{ textAlign: "center" }}>
          <h1 style={{ fontFamily: "Fraunces, serif", fontWeight: 500, fontSize: 24 }}>Cek emailmu</h1>
          <p className="subtitle">
            Kami mengirim tautan konfirmasi ke {email}. Buka tautan itu untuk mengaktifkan akunmu, lalu masuk.
          </p>
          <Link href="/login">
        ...
        <div className="form-box">
          ...
          <form onSubmit={handleSubmit}>
            <div className="field">
              ...
              <input id="name" type="text" placeholder="Nama lengkap" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
